	...
	return (
		<div className="flex flex-col justify-center items-center">
			...
			{data.planets.map((planet: Planet, index: number) => (
				<div className="bg-gray-800 text-white p-4 m-4">
					<div className="text-xl font-bold mb-4" key={index}>{planet.name}</div>
			...
			{data.dwarfPlanets.map((dwarfPlanet: DwarfPlanet, index: number) => (
				<div className="bg-gray-800 text-white p-4 m-4">
					<div className="text-xl font-bold mb-4" key={index}>{dwarfPlanet.name}</div>
			...
			{data.comets.map((comet: Comet, index: number) => (
				<div className="bg-gray-800 text-white p-4 m-4">
					<div className="text-xl font-bold mb-4" key={index}>{comet.name}</div>
